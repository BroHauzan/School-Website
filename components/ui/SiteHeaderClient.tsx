...
export function SiteHeaderClient({
  ...
  return (
    ...
    >
      <div className="mx-auto flex h-16 w-full max-w-6xl items-center justify-between gap-4 px-4 sm:gap-6 sm:px-6 lg:h-[72px] lg:justify-center xl:gap-8">
        <Link
          href="/"
          className={cn(
        ...
        >
          ...
          />
          <span className="whitespace-nowrap text-xs uppercase tracking-[0.14em] sm:text-sm sm:tracking-[0.18em]">
        ...
        <button
          ...
          onClick={() => setOpen((v) => !v)}
          className={cn(
            // `shrink-0`: tanpa ini flexbox memencet tombol jadi 20px di layar
            // sempit dan baris header tetap meluber.
            "flex size-10 shrink-0 items-center justify-center lg:hidden",
            overDark ? "text-cream" : "text-ink"
          )}
        >
