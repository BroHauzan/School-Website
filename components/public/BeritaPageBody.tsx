...
/**
 * Isi halaman `/berita` — dipindahkan apa adanya dari `app/berita/page.tsx`
 * (filter bulan, kartu sorotan, empty state, dan CTA dipertahankan utuh).
 *
 * Komponen ini async server component; hero + header tetap dirender oleh
 * `HalamanSistemPage` agar struktur visual sama.
 */
export async function BeritaPageBody({
  bulanParam,
}: {
  bulanParam?: string;
}) {
